...
<!-- JQuery -->
		...
		<!-- potrzebne do clasy ace-nav -> poker-nav -->
		<link rel="stylesheet" href="resources/css/poker-rtl.min.css" />       <!-- <link rel="stylesheet" href="assets/css/ace-rtl.min.css" /> -->
					...
					<ul class="nav poker-nav">
						...
						<li class="poker-green dropdown-modal">
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li>
									<a href="#">
										<i class="poker-icon fa fa-cog"></i>
										Settings
									</a>
								</li>
								...
								<li>
									<a href="profile.html">
										<i class="poker-icon fa fa-user"></i>
										Profile
									</a>
								</li>
								...
								<li>
									...
									<a href='<spring:url value="/logout" />'>
										<i class="poker-icon fa fa-power-off"></i>
										Logout
									</a>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Exoo</span>
							&copy; 2017
						</span>
